...
const studyRows: StudyRow[] = [
  { id: "P01", group: "A1", users: USERS_PER_PARTICIPANT, name: "Yasmine Trabelsi", age: 28, city: "Tunis", persona: "Cautious planner", hikeFrequency: "4x/mo", phase: "Phase 1", firstTap: "Routes", timeOnTask: 198, usability: 5, quitTime: 198, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P02", group: "A1", users: USERS_PER_PARTICIPANT, name: "Karim Ayari", age: 35, city: "Sfax", persona: "Experienced organiser", hikeFrequency: "6x/mo", phase: "Phase 2", firstTap: "Routes", timeOnTask: 172, usability: 6, quitTime: 172, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P03", group: "A1", users: USERS_PER_PARTICIPANT, name: "Rayen Meherzi", age: 23, city: "Gobaa", persona: "Impulsive adventurer", hikeFrequency: "3x/mo", phase: "Phase 2", firstTap: "Map", timeOnTask: 128, usability: 4, quitTime: 64, quitPage: "Route Detail", lastAction: "Back click" },
  { id: "P04", group: "A1", users: USERS_PER_PARTICIPANT, name: "Lina B.", age: 31, city: "Tunis", persona: "Cautious planner", hikeFrequency: "2x/mo", phase: "Phase 1", firstTap: "Routes", timeOnTask: 218, usability: 5, quitTime: 218, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P05", group: "A1", users: USERS_PER_PARTICIPANT, name: "Nabil H.", age: 40, city: "Bizerte", persona: "Experienced organiser", hikeFrequency: "5x/mo", phase: "Phase 2", firstTap: "Routes", timeOnTask: 165, usability: 6, quitTime: 165, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P06", group: "A2", users: USERS_PER_PARTICIPANT, name: "Sarra M.", age: 26, city: "Nabeul", persona: "Cautious planner", hikeFrequency: "2x/mo", phase: "Phase 1", firstTap: "Routes", timeOnTask: 205, usability: 5, quitTime: 105, quitPage: "Filter", lastAction: "UI Stalling" },
  { id: "P07", group: "A2", users: USERS_PER_PARTICIPANT, name: "Amir K.", age: 33, city: "Sfax", persona: "Experienced organiser", hikeFrequency: "5x/mo", phase: "Phase 2", firstTap: "Routes", timeOnTask: 178, usability: 6, quitTime: 178, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P08", group: "A2", users: USERS_PER_PARTICIPANT, name: "Tarek Z.", age: 22, city: "Sousse", persona: "Impulsive adventurer", hikeFrequency: "4x/mo", phase: "Phase 3", firstTap: "Routes", timeOnTask: 125, usability: 5, quitTime: 58, quitPage: "Search", lastAction: "Error" },
  { id: "P09", group: "A2", users: USERS_PER_PARTICIPANT, name: "Mariem F.", age: 29, city: "Tunis", persona: "Cautious planner", hikeFrequency: "3x/mo", phase: "Phase 1", firstTap: "Map", timeOnTask: 225, usability: 5, quitTime: 225, quitPage: "Success", lastAction: "Feature Activation" },
  { id: "P10", group: "A2", users: USERS_PER_PARTICIPANT, name: "Bilel R.", age: 38, city: "Monastir", persona: "Experienced organiser", hikeFrequency: "6x/mo", phase: "Phase 2", firstTap: "Alerts", timeOnTask: 168, usability: 6, quitTime: 168, quitPage: "Success", lastAction: "Feature Activation" },
];
